...
// Check whether the login details have been submitted.
...
// We include the header frame, which includes all the information in the <head> section on every page.
require 'reso/frames/header.php';
?>
<div class="container">
  <div class="row">
<?php
// Give information to the customer why they have been redirected to the log-in page, if they are redirected.
...
?>
  ...
  <!-- The Amaclone logo is displayed above the log-in. -->
  <div class="row">
    <div class="col-lg-4 mx-auto">
      <img src="reso/static/img/amaclone.png" class="mt-2 mb-2 img w-50" style="margin-left:25%" alt="Responsive image">
    </div>
  </div>
  <!-- We include here the form for submitting the log on credentials. -->
  <div class='row'>
    <div class='col-lg-4 mx-auto'>
      <div class='border rounded  p-3'>
        ...
        <br />
        <!-- The hr-text class allows some text to be surrounded by horizontal rule. -->
        <hr class='hr-text' data-content='New to Amaclone?' >
        <!-- This section allows the user the option to easily register if they haven't already. -->
