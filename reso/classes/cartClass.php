<!-- This file creates the cart class with the following functionality:
cart->cart_contents obtains the contents of the cart stored in the $_SESSION superglobal;
cart->total_items obtains the total number of items in the cart;
cart->total obtains the total cost of the items in the cart;
cart->insert inserts one item into the cart;
cart->update updates the cart;
cart->remove deltes one element from the cart;
cart->destroy removes the cart and the data stored in the session superglobal.
We have the private function cart->save_cart, which saves the cart information to the session.
  -->
<?php
class Cart {
