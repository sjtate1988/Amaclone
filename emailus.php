<!-- This page gives the user the option to send a message to Amaclone. It responds with an email generated through mailgun. -->
<?php
...
// Private details are set in mailgun.php - you can make your own version of this.
  require 'mailgun.php';
